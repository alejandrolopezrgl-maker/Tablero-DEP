...
with tab_plan:
    ...
    if "db_plan_puro_19_v2" not in st.session_state or st.session_state.db_plan_puro_19_v2 is None:
        # PRIMER RENGLÓN CON CÓDIGO Y SITUACIÓN VACIADOS ("")
        cods = [
        ...
        resps = [
            "Alejandro López", "Alfredo Aguilar", "Alfredo Aguilar", "Alfredo Aguilar", "Alfredo Aguilar", 
    ...
    if "db_ampliacion_2_limpia" not in st.session_state or st.session_state.db_ampliacion_2_limpia is None:
        # ÚNICAMENTE EN LAS FILAS DE ESG (8.5.1 Y 8.5.3) SE DEJA EL RESPONSABLE EN BLANCO ("")
        rows_a = [
